...
- Verify disposable Code Extension init, scan, run, and zip workflows for scripts and functions; retain the sandbox
  deployment gate because available test orgs don't have `CdpCustomCodeDeployment` enabled.
