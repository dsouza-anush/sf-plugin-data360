...
export abstract class ProfileCommand<T> extends Data360Command<T> {
  protected async initializeProfile(command: unknown): Promise<{ flags: RuntimeFlags; client: SsotClient }> {
