...
import { MappingClient } from './client.js';
...
export abstract class MappingCommand<T> extends Data360Command<T> {
  protected async initializeMapping(command: unknown): Promise<{ flags: RuntimeFlags; client: MappingClient }> {
